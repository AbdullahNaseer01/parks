    ...
    <footer className=" pt-4 lg:px-16 px-4  bg-[#282A35]">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex flex-col gap-2 text-sm">
          ...
          <a href="#" className="text-white">UPSC - Union Public Service Commission</a>
          <a href="#" className="text-white">General Knowledge</a>
          <a href="#" className="text-white">MBA</a>
          <p className="text-base font-bold tracking-wide text-white">
            Popular Topics
          </p>
          <a href="#" className="text-white">Human Resource Management</a>
          <a href="#" className="text-white">Operations Management</a>
          <a href="#" className="text-white">Marketing Management</a>
        </div>
        <div>
          <p className="text-base font-bold tracking-wide text-white">
