...
function Achievement() {
  return (
    ...
    <div
      ...
      <div
        className="flex flex-col justify-center items-center bg-[#389b87bb] px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
        ...
        <p className="font-medium text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">Expert Chat &amp; Call Minutes</p>
      </div>
      <div
        className="flex flex-col justify-center items-center bg-[#389b87bb] px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
        <div className="flex flex-row justify-center items-center">
